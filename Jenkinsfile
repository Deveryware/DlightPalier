                ...
                withCredentials([
                    ...
                    "MQTT_SERVICE_URL=wss://deverylight-${target}.deveryware.team/mqtt"
                        ...
                        stage ('build ios') {
                            ...
                            sh 'npm install && npm install cordova-custom-config && cordova plugin add cordova-fabric-plugin --variable FABRIC_API_SECRET=$FABRIC_API_SECRET --variable FABRIC_API_KEY=$FABRIC_API_KEY && ionic cordova prepare ios'
                        }
                    }
                }
